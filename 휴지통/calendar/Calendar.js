...
// import style from "components/calendar/calendar";
...
const Calendar = () => {
  ...
  const returnDay = useCallback(() => {
    ...
    for (const nowDay of week) {
      ...
      if (week[day] === nowDay) {
        ...
        dayArr.push(<View className="weekday"></View>);
      }
    }
  ...
  return (
    <View className="container">
      ...
      <View className="week">{returnWeek()}</View>
      <View className="date">{returnDay()}</View>
    </View>
  );
};
